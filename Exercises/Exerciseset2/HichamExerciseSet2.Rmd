...
**Your Answers here:**
<br>Question 1:
<br>6 components needed to explain 50% of variance
<br>
<br>
<br>Question 2:
<br>5 yr T-Notes US (0.93), 10yr T-Notes (0.93), Treasury Bonds (0.86), 2 yr T-note US (0.85)
<br>
<br>
<br>Question 3:
<br>1: Bonds
...
**Your Answers here:**
<br>Question 1:
<br>The first part of the code clones the futures_data matrix into a signal_used matrix (by *0)
...
The signals used matrix is then added to another matrix that is made by looking at the futures_data matrix
...
Since you only have one dollar to invest each day you now need to normalise each row so the absolute magnitudes sum to 
...
<br>Question 2:
<br>Changing the sequence affects the length of period for which MA is calculated. The longer the period the more smooth the graph
<br>
<br>
<br>
